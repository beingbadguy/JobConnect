  ...
  return (
    <div className="  ">
      ...
      <div className="min-h-[78vh] md:min-h-[86vh] flex justify-center items-center flex-col  ">
        <img src=".\3.png" alt="" className="h-48 md:h-64 mb-10" />
        ...
        <p className="mx-4 my-5 md:w-[400px] text-center font-bold text-lg">
        ...
        <div className="flex items-center justify-center  gap-4 mx-4 flex-col sm:flex-row w-full">
          <div className="flex items-center justify-between gap-2 border-2 border-black p-1 w-[70%]  rounded sm:w-[40%] md:w-[20%]">
            <AiFillChrome className="text-2xl mx-2" />
            <input
              type="text "
          ...
          <button
            className={` font-bold bg-black  text-white p-2 rounded w-[70%]  sm:w-[20%] md:w-[10%]`}
            onClick={() => {
